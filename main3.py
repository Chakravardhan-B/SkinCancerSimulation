...
def main(network):
    ...
    train_loader, val_loader, test_loader = CustomDataLoader('./data/' + data, batches=batch)
    ...
    # optimizer = torch.optim.Adadelta(params=[{'params': model.features.parameters()}], lr=1e-3, weight_decay=5e-4)
